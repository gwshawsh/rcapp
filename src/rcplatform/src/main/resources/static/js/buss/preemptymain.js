    ...
    $("#jqGrid").jqGrid({
        ...
        colModel: [
							                    { label: 'id', name: 'id', width: 50, key: true,hidden:true },
											                    ...
											                    { label: '箱型', name: 'boxtypeboxsize', width: 80 },                 							                    { label: '提箱场站', name: 'takeboxplaceidname', width: 80 },                 							                    { label: '目的地', name: 'endplaceidname', width: 80 },                 							                    { label: '计划开始日期', name: 'bgntakedate', width: 80 }, 
