...
var vm = new Vue({
	...
	data:{
	    q:{
                billno:"",                 refbillno:"",                 refbilltype:"",                 orgid:"",                 ladingcode:"",                 shipname:"",                 flight:"",                 portid:"",                 boxqty:"",                 boxtype:"",                 takeboxplaceid:"",                 endplaceid:"",                 bgnshipdatetime:"",                 endshipdatetime:"",                 bgnplanarrtime:"",                 endplanarrtime:"",                 yingshou:"",                 yingfu:"",                 remark:"",                 billstatus:"",                 makeuser:"",                 makedate:"",                 accuser:"",                 accdate:"",                 uptdate:""            },
		showList: true,
        showDetailList:true,
		title: null,
    //用于日期快捷控件
	...
	methods: {
        ...
        //生成参照调用函数
                    ...
                    showrefgrid_organization("参照", function (data) {
                        var seldata = data;
                        vm.takeboxmain.orgid =seldata['id'];
                        vm.takeboxmain.orgidorganizationname =seldata['name'];
                    });
                },
                                                                                                            selectportidplace: function (event) {
                    showrefgrid_place("参照", function (data) {
                        var seldata = data;
                        vm.takeboxmain.portid =seldata['id'];
                        vm.takeboxmain.portidplacename =seldata['name'];
                    });
                },
                                                                                        selecttakeboxplaceidplace: function (event) {
                    showrefgrid_place("参照", function (data) {
                        var seldata = data;
                        vm.takeboxmain.takeboxplaceid =seldata['id'];
                        vm.takeboxmain.takeboxplaceidplacename =seldata['name'];
                    });
                },
                                                selectendplaceidplace: function (event) {
                    showrefgrid_place("参照", function (data) {
                        var seldata = data;
                        vm.takeboxmain.endplaceid =seldata['id'];
                        vm.takeboxmain.endplaceidplacename =seldata['name'];
                    });
                },
        ...
        additem:function(){
            ...
            var item={
                                                            id:"",                                                                                 billno:"*",                                                                                 serialno:idx,                                                                                 transcompanyid:"",                                                                                 startplaceid1:"",                                                                                 startplaceid2:"",                                                                                 endplaceid:"",                                                                                 boxno:"",                                                                                 fengno:"",                                                                                 plantaketime:"",                                                                                 realtaketime:"",                                                                                 planarrvetime:"",                                                                                 realarrvetime:"",                                                                                 yingshou:"",                                                                                 yingfu:"",                                                                                 uptdate:mktime,                                     
            };
    ...
    $("#jqGrid").jqGrid({
        ...
        colModel: [
							                    { label: 'id', name: 'id', width: 50, key: true },
											                    ...
											                    { label: '参照单据类型', name: 'refbilltypeenumvaluename', width: 80 },                 							                    { label: '客户id', name: 'orgid', width: 80 }, 
											                    ...
											                    { label: '箱型', name: 'boxtypeboxsize', width: 80 },                 							                    { label: '提箱场站', name: 'takeboxplaceid', width: 80 }, 
    ...
    $("#jqGridDetail").jqGrid({
        ...
        colModel: [
							                    { label: 'id', name: 'id', width: 50, key: true },
											                    ...
											                    { label: '运输公司', name: 'transcompanyidname', width: 80 }, 											                    { label: '原起运地点', name: 'startplaceid1name', width: 80 }, 											                    { label: '现起运点', name: 'startplaceid2name', width: 80 }, 											                    { label: '目的地', name: 'endplaceidname', width: 80 }, 											                    { label: '箱号', name: 'boxno', width: 80 }, 
