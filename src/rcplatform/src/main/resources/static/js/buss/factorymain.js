...
var vm = new Vue({
	...
	data:{
	    q:{
                                                                            billno:"",                                                                 orgid:"",                                                                 ladingcode:"",                                                                 shipname:"",                                                                 flight:"",                                                                 portid:"",                                                                 boxqty:"",                                                                 boxtype:"",                                                                 takeboxplaceid:"",                                                                 endplaceid:"",                                                                 backplaceid:"",                                                                 bgnshipdatetime:"",                                                                 endshipdatetime:"",                                                                 bgnplanarrtime:"",                                                                 endplanarrtime:"",                                                                 fengxiangtime:"",                                                                 baoguantime:"",                                                                 remark:"",                                                                 billstatus:"",                                                                 makeuser:"",                                                                 makedate:"",                                                                 accuser:"",                                                                 accdate:"",                                                                 uptdate:""                            
        },
		showList: true,
        showQuery:false,
		title: null,
	...
	methods: {
			...
			vm.factorymain = {
                //参照的虚拟字段也必须先声明好,不然饿了么ui组件不能双向绑定
                                                            orgidname:"",
                                                                                ...
                                                                                billstatusenumvaluename:"",
                                                                                makeuserfullname:"",
                                                                                                                                                                billno:"*",                                                                                                                                     orgid:"",                                                                                                                                     ladingcode:"",                                                                                                                                     shipname:"",                                                                                                                                     flight:"",                                                                                                                                     portid:"",                                                                                                                                     boxqty:"",                                                                                                                                     boxtype:"",                                                                                                                                     takeboxplaceid:"",                                                                                                                                     endplaceid:"",                                                                                                                                     backplaceid:"",                                                                                                                                     bgnshipdatetime:"",                                                                                                                                     endshipdatetime:"",                                                                                                                                     bgnplanarrtime:"",                                                                                                                                     endplanarrtime:"",                                                                                                                                     fengxiangtime:"",                                                                                                                                     baoguantime:"",                                                                                                                                     remark:"",                                                                                                                                     billstatus:"",                                                                                                                                     makeuser:gUserId,                                                                                                                                     makedate:mktime,                                                                                                                                     accuser:"",                                                                                                                                     accdate:"",                                                                                                                                     uptdate:""                                                            
            };
		},
        ...
        openRefTreeorganizationorgid: function(){
            ...
            submitworkflow:function () {
                ...
                confirm('确定要提交选中的任务？', function () {
                    $.ajax({
                        type: "POST",
                        url: "../factorymain/submitworkflow",
            ...
            copybill: function (event) {
                ...
                $.get("../factorymain/info/" + id, function (r) {
                    ...
                    vm.factorymain.id=null;
                    vm.factorymain.billno="*";
                });
        ...
        audit:function(event){
            ...
            $.get("../factorymain/info/"+id, function(r){
                ...
                showrefgrid_billcomments(function (data) {
                    if(!vm.factorymain.billcommentsEntity){
                        vm.factorymain.billcommentsEntity={};
                    }
                    vm.factorymain.billcommentsEntity.billno=vm.factorymain.billno;
                    vm.factorymain.billcommentsEntity.refbilltype=0;
                    vm.factorymain.billcommentsEntity.remark=data.remark;
                    vm.factorymain.billcommentsEntity.auditstatus=data.auditstatus;
                    $.ajax({
                        type: "POST",
        ...
        upload_on_success:function (response,file,fileList) {
            ...
            if(!vm.factorymain.files){
                vm.factorymain.files=[];
            }
            if(response.page.list&&response.page.list.length>0){
                vm.factorymain.files.push(response.page.list[0]);
            }
    ...
    $("#jqGrid").jqGrid({
        ...
        colModel: [
			                                                            { label: 'id', name: 'id', width: 50, key: true,hidden:true },
                                    			                                                            ...
                                    			                                                            { label: '箱型', name: 'boxtypeboxsize', width: 80 },                                     			                                                            { label: '提箱场站', name: 'takeboxplaceidname', width: 80 },                                     			                                                            { label: '装卸地', name: 'endplaceidname', width: 80 },                                     			                                                            { label: '返回地', name: 'backplaceidname', width: 80 },                                     			                                                            { label: '集港时间', name: 'bgnshipdatetime', width: 80 }, 
