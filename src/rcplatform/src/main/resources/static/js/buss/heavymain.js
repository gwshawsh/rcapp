        ...
        heavymain: {
                                                orgidname:"",
                                                                ...
                                                                billstatusenumvaluename:"",
                                                                                                        billno:"",                                                                 orgid:"",                                                                 ladingcode:"",                                                                 shipname:"",                                                                 flight:"",                                                                 portid:"",                                                                 boxqty:"",                                                                 boxtype:"",                                                                 takeboxplaceid:"",                                                                 endplaceid:"",                                                                 bgnshipdatetime:"",                                                                 endshipdatetime:"",                                                                 bgnplanarrtime:"",                                                                 endplanarrtime:"",                                                                 remark:"",                                                                 billstatus:"",                                                                 makeuser:"",                                                                 makedate:"",                                                                 accuser:"",                                                                 accdate:"",                                                                 uptdate:""                            
        }
	},
	methods: {
		query: function () {
		...
		add: function(){
            ...
            //参照的虚拟字段也必须先声明好,不然饿了么ui组件不能双向绑定
                                                orgidname:"",
                                                                ...
                                                                boxtypeboxsize:"",
                                                                billstatusenumvaluename:"",
                                                                                                                                                                                billno:"*",                                                                                                                                                             orgid:"",                                                                                                                                                             ladingcode:"",                                                                                                                                                             shipname:"",                                                                                                                                                             flight:"",                                                                                                                                                             portid:"",                                                                                                                                                             boxqty:"",                                                                                                                                                             boxtype:"",                                                                                                                                                             takeboxplaceid:"",                                                                                                                                                             endplaceid:"",                                                                                                                                                             bgnshipdatetime:"",                                                                                                                                                             endshipdatetime:"",                                                                                                                                                             bgnplanarrtime:"",                                                                                                                                                             endplanarrtime:"",                                                                                                                                                             remark:"",                                                                                                                                                             billstatus:"",                                                                                                                                                             makeuser:gUserName,                                                                                                                                                             makedate:mktime,                                                                                                                                                             accuser:"",                                                                                                                                                             accdate:"",                                                                                                                                                             uptdate:""                                                                        
            };
		},
        ...
        //生成参照调用弹出框函数
                    ...
                    showrefgrid_organization("参照", function (data) {
                        var seldata = data;
                        vm.heavymain.orgid =seldata['id'];
                        vm.heavymain.orgidorganizationname =seldata['name'];
                    });
                },
																							                selectportidplace: function (event) {
                    showrefgrid_place("参照", function (data) {
                        var seldata = data;
                        vm.heavymain.portid =seldata['id'];
                        vm.heavymain.portidplacename =seldata['name'];
                    });
                },
																		                selecttakeboxplaceidplace: function (event) {
                    showrefgrid_place("参照", function (data) {
                        var seldata = data;
                        vm.heavymain.takeboxplaceid =seldata['id'];
                        vm.heavymain.takeboxplaceidplacename =seldata['name'];
                    });
                },
								                selectendplaceidplace: function (event) {
                    showrefgrid_place("参照", function (data) {
                        var seldata = data;
                        vm.heavymain.endplaceid =seldata['id'];
                        vm.heavymain.endplaceidplacename =seldata['name'];
                    });
                },
