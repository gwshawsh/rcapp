...
var vm = new Vue({
	...
	data:{
	    q:{
                                                                            billno:"",                                                                 orgid:"",                                                                 ladingcode:"",                                                                 shipname:"",                                                                 flight:"",                                                                 portid:"",                                                                 boxqty:"",                                                                 boxtype:"",                                                                 takeboxplaceid:"",                                                                 endplaceid:"",                                                                 bgnshipdatetime:"",                                                                 endshipdatetime:"",                                                                 bgnplanarrtime:"",                                                                 endplanarrtime:"",                                                                 fengxiangtime:"",                                                                 baoguantime:"",                                                                 remark:"",                                                                 billstatus:"",                                                                 makeuser:"",                                                                 makedate:"",                                                                 accuser:"",                                                                 accdate:"",                                                                 uptdate:""                            
        },
		showList: true,
        showQuery:false,
        showDetailList:true,
	...
	methods: {
			...
			vm.heavymain = {
                //参照的虚拟字段也必须先声明好,不然饿了么ui组件不能双向绑定
                                                            orgidname:"",
                                                                                ...
                                                                                billstatusenumvaluename:"",
                                                                                makeuserfullname:"",
                                                                                                                                                                billno:"*",                                                                                                                                     orgid:"",                                                                                                                                     ladingcode:"",                                                                                                                                     shipname:"",                                                                                                                                     flight:"",                                                                                                                                     portid:"",                                                                                                                                     boxqty:"",                                                                                                                                     boxtype:"",                                                                                                                                     takeboxplaceid:"",                                                                                                                                     endplaceid:"",                                                                                                                                     bgnshipdatetime:"",                                                                                                                                     endshipdatetime:"",                                                                                                                                     bgnplanarrtime:"",                                                                                                                                     endplanarrtime:"",                                                                                                                                     fengxiangtime:"",                                                                                                                                     baoguantime:"",                                                                                                                                     remark:"",                                                                                                                                     billstatus:"",                                                                                                                                     makeuser:gUserId,                                                                                                                                     makedate:mktime,                                                                                                                                     accuser:"",                                                                                                                                     accdate:"",                                                                                                                                     uptdate:""                                                            
            };
		},
        ...
        getRefTreeorganizationorgid: function(menuId){
            ...
            $.get("../organization/select", function(r){
                ...
                var node = ztreeorgid.getNodeByParam("id", vm.heavymain.orgid);
                ztreeorgid.selectNode(node);
                vm.heavymain.orgidname = node.name;
        ...
        openRefTreeorganizationorgid: function(){
            layer.open({
                ...
                btn1: function (index) {
                    ...
                    //选择上级菜单
                    vm.heavymain.orgid = node[0].id;
                    vm.heavymain.orgidname = node[0].name;
        ...
        audit:function(event){
            ...
            $.get("../heavymain/info/"+id, function(r){
                ...
                showrefgrid_billcomments(function (data) {
                    if(!vm.heavymain.billcommentsEntity){
                        vm.heavymain.billcommentsEntity={};
                    }
                    vm.heavymain.billcommentsEntity.billno=vm.heavymain.billno;
                    vm.heavymain.billcommentsEntity.refbilltype=0;
                    vm.heavymain.billcommentsEntity.remark=data.remark;
                    vm.heavymain.billcommentsEntity.auditstatus=data.auditstatus;
                    $.ajax({
                        type: "POST",
                        url: "../heavymain/audit",
                        data: JSON.stringify(vm.heavymain),
        ...
        upload_on_success:function (response,file,fileList) {
            ...
            if(!vm.heavymain.files){
                vm.heavymain.files=[];
            }
            if(response.page.list&&response.page.list.length>0){
                vm.heavymain.files.push(response.page.list[0]);
            }
    ...
    $("#jqGrid").jqGrid({
        ...
        colModel: [
			                                                            { label: 'id', name: 'id', width: 50, key: true,hidden:true },
                                    			                                                            ...
                                    			                                                            { label: '箱型', name: 'boxtypeboxsize', width: 80 },                                     			                                                            { label: '提箱场站', name: 'takeboxplaceidname', width: 80 },                                     			                                                            { label: '目的地', name: 'endplaceidname', width: 80 },                                     			                                                            { label: '集港时间', name: 'bgnshipdatetime', width: 80 }, 
                                    			                                                            ...
                                    			                                                            { label: '封箱时间', name: 'fengxiangtime', width: 80 }, 
                                    			                                                            { label: '报关时间', name: 'baoguantime', width: 80 }, 
