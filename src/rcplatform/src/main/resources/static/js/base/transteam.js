...
$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            { label: '车辆类型', name: 'vehicleType', width: 80, formatter: function(value, options, row){
                if(value==0){
                    return  '<span class="label label-danger">自营</span>';
                }
                else if(value==1){
                    return  '<span class="label label-danger">挂靠</span>';
                }
                else {
                    return  '<span class="label label-danger">外协</span>';
                }
