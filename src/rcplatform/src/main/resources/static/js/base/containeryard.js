...
var vm = new Vue({
	...
	methods: {
		...
		saveOrUpdate: function (event) {
			var url = vm.containeryard.id == null ? "../containeryard/save" : "../containeryard/update";
			$.ajax({
				type: "POST",
			    url: url,
			    data: JSON.stringify(vm.containeryard),
			    success: function(r){
			    	if(r.code === 0){
