...
var vm = new Vue({
    ...
    methods: {
        ...
        getRefTreefeeinfoparentId: function (menuId) {
            //加载菜单树
            $.get("../feeinfo/select", function (r) {
                ...
                vm.feeinfo.parentIdname = node.name;

            })
        },

        openRefTreefeeinfoparentId: function () {
            layer.open({
                type: 1,
                offset: '50px',
                ...
                btn1: function (index) {
                    ...
                    vm.feeinfo.parentIdname = node[0].name;
        ...
        getRefTreesys_deptdeptid: function (menuId) {
            ...
            $.get("../sys_dept/select", function (r) {
                ...
                var node = ztreedeptid.getNodeByParam("id", vm.feeinfo.deptid);
                ztreedeptid.selectNode(node);
                vm.feeinfo.deptidname = node.name;
        ...
        openRefTreesys_deptdeptid: function () {
            layer.open({
                ...
                btn1: function (index) {
                    ...
                    //选择上级菜单
                    vm.feeinfo.deptid = node[0].id;
                    vm.feeinfo.deptidname = node[0].name;
...
$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            {label: '责任部门', name: 'deptid', width: 80},
