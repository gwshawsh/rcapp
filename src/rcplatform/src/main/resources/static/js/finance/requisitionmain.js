...
$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            {label: '请购人', name: 'requserusername', width: 80}, {
                label: '所属部门',
                name: 'deptidname',
                width: 80
            }, {label: '请购类别', name: 'reqtypeenumvaluename', width: 80}, {
                label: '预算计划',
                name: 'budgetmainid',
                width: 80
            },
            {label: '单据状态', name: 'billstatus', width: 80, formatter: formater_billstatus},
            {label: '制单人', name: 'makeuserusername', width: 80}, {label: '制单日期', name: 'makedate', width: 80},
            {label: '审核人', name: 'accuserusername', width: 80}, {label: '审核日期', name: 'accdate', width: 80},
