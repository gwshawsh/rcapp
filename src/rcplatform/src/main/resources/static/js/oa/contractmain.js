...
var vm = new Vue({
	...
	data:{
	    q:{
                billno:"",                 partyaid:"",                 partybid:"",                 billtype:"",                 paytype:"",                 paycircleid:"",                 bgndate:"",                 enddate:"",                 remark:"",                 billstatus:"",                 makeuser:"",                 makedate:"",                 accuser:"",                 accdate:"",                 uptdate:"",                 pocessinstanceid:""            },
        showQuery:false,
		showList: true,
        showDetailList:true,
		title: null,
    ...
    $("#jqGrid").jqGrid({
        ...
        colModel: [
			                                                            { label: 'id', name: 'id', width: 50, key: true,hidden:true },
                    							                                                            { label: '单据号', name: 'billno', width: 80 },                     							                                                            { label: '甲方', name: 'partyaid', width: 80 },                     							                                                            { label: '乙方', name: 'partybid', width: 80 },                     							                                                            { label: '收付款类型', name: 'billtypeenumvaluename', width: 80 },                     							                                                            { label: '付款方式', name: 'paytypeenumvaluename', width: 80 },                     							                                                            { label: '结算周期', name: 'paycircleidname', width: 80 },                     							                                                            { label: '生效日期', name: 'bgndate', width: 80 },                     							                                                            { label: '失效日期', name: 'enddate', width: 80 },                     							                                                            { label: '备注', name: 'remark', width: 80 },                     							                                                            { label: '单据状态', name: 'billstatus', width: 80 ,formatter:formater_billstatus}, 
                    							                                                            { label: '制单人', name: 'makeuserfullname', width: 80 },                     							                                                            { label: '制单日期', name: 'makedate', width: 80 },                     							                                                            { label: '审核人', name: 'accuserfullname', width: 80 },                     							                                                            { label: '审核日期', name: 'accdate', width: 80 },                     							                                                            { label: '更新时间', name: 'uptdate', width: 80 },                     							                			        ],
        viewrecords: true,
        height: 385,
        rowNum: 10,
        rowList : [10,30,50],
