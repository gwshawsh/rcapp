 ...
 */
public class ExpensemainEntity extends AbstractEntity implements Serializable {
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("<form class=\"el-form rcp-table-expand el-form--label-left el-form--inline\">");
                        ...
                        "  <div class=\"el-form-item__content\"><a class='billno' onclick=\"openfunc('expensemain/index','报销单')\"><span>"+getBillno()+"</span></a>\n" +
                        "  </div> </div>");
