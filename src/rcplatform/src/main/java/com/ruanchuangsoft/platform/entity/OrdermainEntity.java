...
public class OrdermainEntity extends AbstractEntity implements Serializable {
    ...
    public String toString() {
        ...
        sb.append(" <div class=\"el-form-item\">\n" +
                ...
                "  <div class=\"el-form-item__content\"><a class='billno' onclick=\"openfunc('ordermain/index','订购管理')\"><span>" + getBillno() + "</span></a>\n" +
                "  </div> </div>");

        sb.append(" <div class=\"el-form-item\">\n" +
                "  <label class=\"el-form-item__label\">供应商</label>" +
                "  <div class=\"el-form-item__content\"><span>" + getSupplyid() + "</span>\n" +
                "  </div> </div>");
        ...
        sb.append(" <div class=\"el-form-item\">\n" +
                ...
                "  <div class=\"el-form-item__content\"><span>" + getRequserusername() + "</span>\n" +
                "  </div> </div>");
        ...
        sb.append(" <div class=\"el-form-item\">\n" +
                ...
                "  <div class=\"el-form-item__content\"><span>" + getAccuserusername() + "</span>\n" +
                "  </div> </div>");
        ...
        sb.append(" <div class=\"el-form-item\">\n" +
                "  <label class=\"el-form-item__label\">流程ID</label>" +
                "  <div class=\"el-form-item__content\"><span>" + getPocessinstanceid() + "</span>\n" +
                "  </div> </div>");
