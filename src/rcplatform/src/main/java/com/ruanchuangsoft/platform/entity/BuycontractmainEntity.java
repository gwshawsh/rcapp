 ...
 */
public class BuycontractmainEntity implements Serializable {
	...
	//单据明细
	private List<BuycontractdetailEntity> details;

	public void setDetails(List<BuycontractdetailEntity> details) {
        this.details = details;
    }

    public List<BuycontractdetailEntity> getDetails() {
        return details;
    }
