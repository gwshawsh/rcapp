 ...
 */
public class RepaircontractmainEntity implements Serializable {
	...
	//单据明细
	private List<RepaircontractdetailEntity> details;

	public void setDetails(List<RepaircontractdetailEntity> details) {
        this.details = details;
    }

    public List<RepaircontractdetailEntity> getDetails() {
        return details;
    }
