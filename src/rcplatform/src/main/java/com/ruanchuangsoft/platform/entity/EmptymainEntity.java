...
public class EmptymainEntity implements Serializable {
    ...
    //是否放箱
    private String istakeboxenumvalueid;


    //是否运输
    private String istransenumvalueid;
     ...
     * 设置：是否放箱enumvalueid
     */
    public void setIstakeboxenumvalueid(String enumvalueid) {
        this.istakeboxenumvalueid = enumvalueid;
    }

    /**
     * 获取：是否放箱enumvalueid
     */
    public String getIstakeboxenumvalueid() {
        return istakeboxenumvalueid;
    }

    /**
     * 设置：是否运输enumvalueid
     */
    public void setIstransenumvalueid(String enumvalueid) {
        this.istransenumvalueid = enumvalueid;
    }

    /**
     * 获取：是否运输enumvalueid
     */
    public String getIstransenumvalueid() {
        return istransenumvalueid;
    }
