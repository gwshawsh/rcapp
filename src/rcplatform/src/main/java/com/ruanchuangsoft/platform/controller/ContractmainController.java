...
//		initModelAndViewI18N(view,keys);
    ...
    public R submitworkflow(@RequestBody Long id){
        ...
        String processid=startWorkflow("contractmain",contractmainEntity.getBillno(),params);
    ...
    */
    ...
    public R audit(@RequestBody ContractmainEntity contractmainEntity){
        ...
        //生成审核日志
        //新增一条处理记录：审核
        newBillcomments(contractmainEntity.getBillno(),
        ...
        if(task!=null){
            ...
            if(endflag){
                    contractmainEntity.setBillstatus(BillStatus.COMPLETE);
                    contractmainService.update(contractmainEntity);
            }
        }
