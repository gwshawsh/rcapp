 ...
 * @date 2017-07-28 09:03:23
 */
public class FactorymainEntity extends AbstractEntity implements Serializable {
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("<form class=\"el-form rcp-table-expand el-form--label-left el-form--inline\">");
                        ...
                        "  <div class=\"el-form-item__content\"><a class='billno' onclick=\"openfunc('factorymain/index','门点计划')\"><span>"+getBillno()+"</span></a>\n" +
                        "  </div> </div>");
                        ...
                        "  </div> </div>");
					                ...
					                sb.append(" <div class=\"el-form-item\">\n" +
                        "  <label class=\"el-form-item__label\">装卸地</label>"+
                        "  <div class=\"el-form-item__content\"><span>"+getEndplaceidname()+"</span>\n" +
                        "  </div> </div>");
			
					                sb.append(" <div class=\"el-form-item\">\n" +
                        "  <label class=\"el-form-item__label\">返回地</label>"+
                        "  <div class=\"el-form-item__content\"><span>"+getBackplaceidname()+"</span>\n" +
                        "  </div> </div>");
