...
INSERT INTO `sys_menu` (`menu_id`, `parent_id`, `name`, `url`, `perms`, `type`, `icon`, `order_num`) VALUES ('takeboxmain_changebox', 'takeboxmain', '改单', NULL, 'takeboxmain:update,takeboxmain:takeboxchange', '2', NULL, '0');
