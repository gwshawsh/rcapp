...
CREATE TABLE `requisitionmain`(
  ...
  `reqtype` int COMMENT '请购类别:enum:1005:enumvalueid:enumvaluename', --  不同的请购类别对应到不同的协办部门
...
CREATE TABLE `ordermain`(
  ...
  `requser` varchar(50) COMMENT '请购人',
  `deptid` bigint COMMENT '请购部门:combo:dept:dept_id:name',
  `reqdate` datetime COMMENT '请购日期',
  `ordersource` int COMMENT '订购单来源:enum:1001:enumvalueid:enumvaluename', -- 订购单来源，1.请购单转入。2.新增
...
CREATE TABLE `paymentmain`(
  ...
  `reqbillno` varchar(50) COMMENT '请购单据号',
  `requser` varchar(50) COMMENT '请购人',
  `deptid` varchar(50) COMMENT '请购部门:combo:dept:dept_id:name',
  ...
  `payeeaccount` bigint COMMENT '收款人账号:dialog:bankaccount:id:accountno',
...
CREATE TABLE `leavework` (
  ...
  `leavetype` int COMMENT '类型:enum:1001:enumvalueid:enumvaluename', --   0：生病   1：结婚   2：其他',
...
CREATE TABLE `organization` (
  ...
  `busstype` varchar(50) COMMENT '业务类型:enum:2002:enumvalueid:enumvaluename',
...
CREATE TABLE `bank` (
  ...
  `code` varchar(50) COMMENT '编码',
  `name` varchar(50) COMMENT '名称', 
  `accountno` varchar(50) COMMENT '帐号', 
...
CREATE TABLE `ship` (
  ...
  `region` bigint COMMENT '所属区域:dialog:region:id:name',
...
CREATE TABLE `emptymain`(
  `id` bigint NOT NULL AUTO_INCREMENT,
  `billno` varchar(50) COMMENT '单据号',
  `orgid` bigint COMMENT '客户id:dialog:organization:id:name',
  `ladingcode` varchar(50) COMMENT '提单号',
  `shipname` varchar(20) COMMENT '船名',
  `flight` varchar(50) COMMENT '航次', 
  `portid` bigint COMMENT '港口id:dialog:place:id:name',
  ...
  `endplaceid` bigint COMMENT '目的地:dialog:place:id:name', 
...
CREATE TABLE `heavymain`(
  ...
  `shipname` varchar(20) COMMENT '船名',
  `flight` varchar(50) COMMENT '航次', 
  `portid` bigint COMMENT '港口:dialog:place:id:name',
  `boxqty` int COMMENT '箱量',
  `boxtype` bigint COMMENT '箱型:combo:boxs:id:boxsize',
  `takeboxplaceid` bigint COMMENT '提箱场站:dialog:place:id:name', 
  `endplaceid` bigint COMMENT '目的地:dialog:place:id:name', 
...
CREATE TABLE `factorymain`(
  ...
  `boxtype` bigint COMMENT '箱型:combo:boxs:id:boxsize',
  `takeboxplaceid` bigint COMMENT '提箱场站:dialog:place:id:name', 
  `endplaceid` bigint COMMENT '装卸地:dialog:place:id:name', 
  `backplaceid` bigint COMMENT '返回地:dialog:place:id:name', 
  `bgnshipdatetime` datetime COMMENT '集港时间',
  `endshipdatetime` datetime COMMENT '截港时间',
  `bgnplanarrtime` datetime COMMENT '最早到场时间',
  `endplanarrtime` datetime COMMENT '最晚到场时间',
...
CREATE TABLE `leaveportmain`(
  `id` bigint NOT NULL AUTO_INCREMENT,
  `billno` varchar(50) COMMENT '单据号',
  `port` bigint COMMENT '港口:dialog:place:id:name',
  `shipcompany` bigint COMMENT '船公司:dialog:organization:id:name',
  `boxqty` int COMMENT '箱量',
  `boxtype` bigint COMMENT '箱型:combo:boxs:id:boxsize',
  `takeboxplaceid` bigint COMMENT '提箱场站:dialog:place:id:name', 
  `endplaceid` bigint COMMENT '目的地:dialog:place:id:name', 
...
CREATE TABLE `takeboxmain`(
  ...
  `boxtype` bigint COMMENT '箱型:combo:boxs:id:boxsize',
  `takeboxplaceid` bigint COMMENT '提箱场站:dialog:place:id:name', 
  `endplaceid` bigint COMMENT '目的地:dialog:place:id:name', -- 空箱计划就是仓库  重箱计划就是港口  门店计划就是工厂
  `bgnshipdatetime` datetime COMMENT '集港时间',
  `endshipdatetime` datetime COMMENT '截港时间',
  `bgnplanarrtime` datetime COMMENT '最早到场时间',
  `endplanarrtime` datetime COMMENT '最晚到场时间',
...
CREATE TABLE `takeboxdetail`(
  ...
  `startplaceid1` bigint COMMENT '原起运地点:dialog:place:id:name',
  `startplaceid2` bigint COMMENT '现起运点:dialog:place:id:name',
  `endplaceid` bigint COMMENT '目的地:dialog:place:id:name',
...
CREATE TABLE `transboxmain`(
  ...
  `orgid` bigint COMMENT '客户:dialog:organization:id:name',
  `ladingcode` varchar(50) COMMENT '提单号',
  `shipname` varchar(20) COMMENT '船名',
  `flight` varchar(50) COMMENT '航次', 
  `portid` bigint COMMENT '港口:dialog:place:id:name',
...
CREATE TABLE `transboxdetail`(
  ...
  `startplaceid2` bigint COMMENT '现起运点:dialog:place:id:name',
  `endplaceid` bigint COMMENT '目的地:dialog:place:id:name',
  `lineid` bigint COMMENT '线路:dialog:transline:id:name',
  `boxno` varchar(50) COMMENT '箱号',
  `fengno` varchar(50) COMMENT '铅封号',
...
CREATE TABLE `storecontractmain`(
  ...
  `paytype` bigint COMMENT '付款方式:combo:paytype:id:name',
  `boctid` bigint COMMENT '币别:dialog:boctype:id:boctypename',
  `rate` decimal(19,4) COMMENT '汇率',
  `taxrate` decimal(19,4) COMMENT '税率',
  `takeboxfee` decimal(19,4) COMMENT '放箱单价',
  `takeboxfeetax` decimal(19,4) COMMENT '放箱单价(税)',
...
CREATE TABLE `budgetdetail`(
  ...
  `accountid` bigint COMMENT '预算科目:dialog:accountcategory:id:name',
  `name` varchar(200) COMMENT '名称',
